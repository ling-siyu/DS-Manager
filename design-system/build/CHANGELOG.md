...
- `--ds-semantic-typography-code-font-family`: `ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace` → `ui-monospace, SFMono-Regular, Menlo, Consolas, 'Noto Sans SC', monospace`
## 2026-06-08

### Changed

- `--ds-semantic-typography-display-font-family`: `'Inter', ui-sans-serif, system-ui, sans-serif` → `'Inter', 'Noto Sans SC', sans-serif`
- `--ds-semantic-typography-heading-xl-font-family`: `'Inter', ui-sans-serif, system-ui, sans-serif` → `'Inter', 'Noto Sans SC', sans-serif`
- `--ds-semantic-typography-heading-lg-font-family`: `'Inter', ui-sans-serif, system-ui, sans-serif` → `'Inter', 'Noto Sans SC', sans-serif`
- `--ds-semantic-typography-heading-md-font-family`: `'Inter', ui-sans-serif, system-ui, sans-serif` → `'Inter', 'Noto Sans SC', sans-serif`
- `--ds-semantic-typography-heading-sm-font-family`: `'Inter', ui-sans-serif, system-ui, sans-serif` → `'Inter', 'Noto Sans SC', sans-serif`
- `--ds-semantic-typography-heading-xs-font-family`: `'Inter', ui-sans-serif, system-ui, sans-serif` → `'Inter', 'Noto Sans SC', sans-serif`
- `--ds-semantic-typography-body-lg-font-family`: `'Inter', ui-sans-serif, system-ui, sans-serif` → `'Inter', 'Noto Sans SC', sans-serif`
- `--ds-semantic-typography-body-base-font-family`: `'Inter', ui-sans-serif, system-ui, sans-serif` → `'Inter', 'Noto Sans SC', sans-serif`
- `--ds-semantic-typography-body-sm-font-family`: `'Inter', ui-sans-serif, system-ui, sans-serif` → `'Inter', 'Noto Sans SC', sans-serif`
- `--ds-semantic-typography-label-lg-font-family`: `'Inter', ui-sans-serif, system-ui, sans-serif` → `'Inter', 'Noto Sans SC', sans-serif`
- `--ds-semantic-typography-label-base-font-family`: `'Inter', ui-sans-serif, system-ui, sans-serif` → `'Inter', 'Noto Sans SC', sans-serif`
- `--ds-semantic-typography-label-sm-font-family`: `'Inter', ui-sans-serif, system-ui, sans-serif` → `'Inter', 'Noto Sans SC', sans-serif`
- `--ds-semantic-typography-caption-font-family`: `'Inter', ui-sans-serif, system-ui, sans-serif` → `'Inter', 'Noto Sans SC', sans-serif`
- `--ds-semantic-typography-overline-font-family`: `'Inter', ui-sans-serif, system-ui, sans-serif` → `'Inter', 'Noto Sans SC', sans-serif`
## 2026-06-08
...
- `--ds-primitive-typography-fontFamily-sans`: `'Inter', ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Noto Sans SC', 'Noto Sans TC', 'Noto Sans JP', 'Noto Sans KR', sans-serif` → `'Inter', 'Noto Sans SC', 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei', 'Source Han Sans SC', 'Heiti SC', system-ui, sans-serif`
- `--ds-primitive-typography-fontFamily-serif`: `ui-serif, Georgia, Cambria, 'Times New Roman', Times, serif` → `Georgia, Cambria, 'Times New Roman', 'Noto Serif SC', 'Source Han Serif SC', 'Songti SC', serif`
- `--ds-primitive-typography-fontFamily-mono`: `ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace` → `ui-monospace, SFMono-Regular, Menlo, Consolas, 'Noto Sans SC', 'PingFang SC', 'Source Han Sans SC', monospace`
## 2026-04-13
